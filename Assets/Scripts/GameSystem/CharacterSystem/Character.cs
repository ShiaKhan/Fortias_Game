...
public class Character : MonoBehaviour
{
    ...
    public List<GameObject> ObjectOnScreen;
    ...
    public void autoPlay(List<Character> Targets,List<GameObject> Enemies,List<GameObject> ObjectsOnScreen)
    {
        if (_ownerView.isAutoPlay)
        {
            if (Targets.Count > 0)
            {
            ...
            if (Enemies.Count > 0)
            {
                AIStrategy.AutoTargetObjects(this, Enemies);
            }
        }
        else
        {
            ...
            {
                AIStrategy.TargetObjects(this, ObjectsOnScreen);
            }else
            {
                this.GetComponent<PlayerMovement>()._controller.MoveToPositionSmooth(originPosition);
            }
        }
